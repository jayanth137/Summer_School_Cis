...
function Timer() {
    const endTime = new Date("2023-07-14T24:00:00").getTime();
    ...
    return ( 
        <div className = "time" >
        <div className = "timer-body" > {screenWidth > 450 ? ( <>
                <div className = "timer" >
                <div className = "hour" > {timeLeft.days < 10 ? `0${timeLeft.days}` : timeLeft.days
                } </div> 
                <div className = "time-label" > Days </div> </div> 
                <div className = "timer" >
                <div className = "separator" >: </div> </div> 
                <div className = "timer" >
                <div className = "hour" > {timeLeft.hours < 10 ? `0${timeLeft.hours}` : timeLeft.hours} 
                </div> <div className = "time-label" > Hours </div> </div>
                ...
                <div className = "separator" >: </div> </div> 
                <div className = "timer timer-mar" >
                <div className = "second" > {timeLeft.seconds < 10 ? `0${timeLeft.seconds}` : timeLeft.seconds } 
                </div> 
                <div className = "time-label" > {
