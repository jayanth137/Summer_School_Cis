const timelineData = [
  ...
  {
    time: 'Day 2  - August 29',
    desc: 'Object Detection & Recognition',
    date: 'Lecture 2',
    dateDesc: 'Workshop 2',
    descInDepth:
      '\nLecture - session 1  \n\n In this combined session, participants delve into the power of AI and computer vision in unmanned vehicles. They explore object detection, recognition, and route planning using AI algorithms, backed by real-world examples. By the end, attendees gain a profound understanding of how AI empowers unmanned vehicles, enabling efficient navigation and enhanced applications across different industries. \n\n Workshop - session 2  \n\n In this workshop, participants train their vehicle with object detection algorithms and develop a robust navigation system through mapping techniques. They learn to fine-tune models for recognizing objects and barriers, and implement SLAM algorithms for accurate mapping. The goal is an autonomous vehicle capable of navigating and responding to its surroundings effectively.',
  },
  {
    time: ' Day 3 - August 30 ',
    desc: 'Navigation & route planning using AI',
    date: 'Lecture 3',
    dateDesc: 'Workshop 3',
    descInDepth:
      '\nLecture - session 1  \n\n This lecture covers AI in autonomous control and predictive maintenance for unmanned vehicles. Using real-world examples, participants learn about decision-making algorithms, path planning, and proactive maintenance. AI empowers unmanned vehicles to function autonomously and ensures optimal reliability and longevity through proactive maintenance.   \n\n Workshop - session 2 \n\n In this workshop, participants will build and refine their unmanned vehicle systems in a single day. They will learn various control algorithms, integrate sensors and actuators, and enable autonomous operations. Practical exercises will focus on developing the vehicles decision-making and obstacle avoidance capabilities. Additionally, participants will optimize performance and prepare for a friendly competition, where they can showcase their vehicles abilities in completing tasks or challenges. \n\n ',
  },
  {
    time: ' Day 4 & 5 - Aug 31 & Sept 1 ',
    desc: 'Tech Fair',

    descInDepth:
      '   Tech Fair : \n\n The Tech Fair in collaboration with Nvidia is a grand platform where technology takes centre stage, offering a diverse array of exhibits, presentations, workshops, and interactive displays. It brings together experts, students, professionals, and industry leaders to share knowledge, network, and collaborate.',
  },
  {
    time: 'Day 5',
