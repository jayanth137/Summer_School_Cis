...
const AccordionItem = ({
    ...
    return ( <li className = { `section7-accordion_item ${isActive ? "active" : ""}` } >
        ...
        style = { isActive ? { height: contentEl.current.scrollHeight  } :  {  height: "0px" } } >
        <div className = "section7-answer" > {faq.answer} </div> </div> </li>
    );
};
