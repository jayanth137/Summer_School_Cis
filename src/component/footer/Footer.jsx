          ...
          <div className="summerschool__footer-social-container">
            <div className="summerschool__footer-social-links-container">
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.instagram.com/ieee.cis.cusb?r=nametag"
              >
                <svg
                  fill="#999"
                  width="32"
              ...
              <a
                target="linkedin"
                href="https://www.linkedin.com/in/ieee-computational-intelligence-society-cusb-a58601236/"
              >
                <svg
                  fill="#999"
                  width="32"
            ...
            <p className="summerschool__footer-social-text">
              <a
                href="mailto:summerschool@gmail.com"
                style={{ color: '#e13b3c' }}
              >
